...
const EditOptions = () => {
  ...
  const { optionsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: optionsId }))
  }, [optionsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: optionsId, data }))
...
EditOptions.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
