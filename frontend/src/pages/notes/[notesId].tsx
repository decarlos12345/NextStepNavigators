...
const EditNotes = () => {
  ...
  return (
    ...
    <FormField label='IsPublic' labelFor='is_public'>
        <Field
            name='is_public'
            id='is_public'
      ...
      >
          <DatePicker
              ...
              showTimeSelect
              selected={initialValues.reminder ?
                  new Date(
                      dayjs(initialValues.reminder).format('YYYY-MM-DD hh:mm'),
                  ) : null
              }
              onChange={(date) => setInitialValues({...initialValues, 'reminder': date})}
          />
      </FormField>
