      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Messages SentBy</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.messages_sent_by && Array.isArray(users.messages_sent_by) &&
                              users.messages_sent_by.map((item: any) => (
                        ...
                        {!users?.messages_sent_by?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
